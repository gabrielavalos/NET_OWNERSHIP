...
interests = pd.read_csv("raw data\PARTNER_INTERESTS.csv", usecols=[0,2,3,4,5,6,7,8,9,10])
...
data= [casey_oil, casey_gas, cml_oil, cml_gas, idc_oil, idc_gas, jason_oil, jason_gas, ken_oil,ken_gas, lanmln_oil, lanmln_gas, patterson_oil,patterson_gas, phil_oil,phil_gas, travis_oil,travis_gas]

gas_data= [casey_gas, cml_gas, idc_gas, jason_gas, ken_gas,lanmln_gas, patterson_gas,phil_gas,travis_gas]
oil_data= [casey_oil, cml_oil, idc_oil, jason_oil, ken_oil,lanmln_oil, patterson_oil,phil_oil,travis_oil]
...
partners_output = [["Casey", "CML", "IDC", "Jason", "Ken", "LAN MLN", "Patterson", "Phil", "Travis"],["OIL", "GAS"]]
...
oil_nets.rename(columns={'CML-OIL':'CML','CASEY-OIL':'CASEY','IDC-OIL':'IDC','JASON-OIL':'JASON','KEN-OIL':'KEN','LANMLN-OIL':'LAN MLN','PATTERSON-OIL':'PATTERSON','PHIL-OIL':'PHIL','TRAVIS-OIL':'TRAVIS'}, inplace= True)
...
#SAVE GAS DATA CSV
gas_nets.rename(columns={'CML-GAS':'CML','CASEY-GAS':'CASEY','IDC-GAS':'IDC','JASON-GAS':'JASON','KEN-GAS':'KEN','LANMLN-GAS':'LAN MLN','PATTERSON-GAS':'PATTERSON','PHIL-GAS':'PHIL','TRAVIS-GAS':'TRAVIS'},inplace= True)
